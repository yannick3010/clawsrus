...
export default function Features() {
  return (
    <section id="features" className="bg-navy-50 py-24 sm:py-32">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2">
          {categories.map((cat, i) => (
            <FadeIn key={cat.title} delay={i * 100}>
              <div className="rounded-2xl border border-navy-100 bg-white p-8 transition-all hover:shadow-lg hover:shadow-navy-100/50">
        ...
        <FadeIn delay={500}>
          <div className="mt-16 rounded-2xl bg-gradient-to-r from-brand-50 to-blue-50 p-8 sm:p-10">
            <h4 className="font-display text-xl text-navy-800">
