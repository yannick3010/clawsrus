...
export function isDashboardUiV2Enabled(): boolean {
  const value = process.env.DASHBOARD_UI_V2 ?? process.env.NEXT_PUBLIC_DASHBOARD_UI_V2;
  // Disabled by default until rollout is complete.
  return value === "true";
}
